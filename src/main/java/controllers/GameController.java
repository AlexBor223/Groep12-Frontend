...
public class GameController {
    ...
    public ArrayList<Abbreviation> getAllAbbreviations() {
        ...
        Abbreviation test1 = new Abbreviation("ACM","Autoriteit Consument en Markt",  Long.valueOf(1), 0, 0);
        Abbreviation test2 = new Abbreviation("BZK", "Binnenlandse Zaken", Long.valueOf(1), 0, 1);
        Abbreviation test3 = new Abbreviation("ETC","Et cetera", Long.valueOf(1), 0, 2);
        Abbreviation test4 = new Abbreviation("WVTTK","Wat verder te tafel komt", Long.valueOf(1), 0, 3);
